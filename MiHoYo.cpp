...
int shopCatagoryButton()
{
    ...
    while (true)
    {
        ...
        cout << "||            Buy Online Save Your Time          ||\n";
        cout << "===================================================\n";
        cout << "  Select category (w/s to change): \n";
        for (int i = 0; i < total; i++)
        {
            if (i == choosen)
            {
...
void removeCatagory()
{
    ...
    if (temp->nextCat == NULL && temp->previousCat == NULL)
    {
        ...
        catHead = NULL;
        cout << endl;
        cout << "Category has been removed\n";
        cout << "Press enter to continue....";
        cin.get();
        cout << "Loading....";
        for (int i = 0; i < 5; i++)
...
void addItemToCatagory()
{
    ...
    while (true)
    {
        cout << "  Enter amount to add (kg/unit): ";
        getline(cin, input);
...
int userCartButton(cartUser *tempCartUser)
{
    ...
    while (true)
    {
        ...
        cout << "        Ordered Amount (kg/unit): " << tempItem->orderddAmount << endl;
